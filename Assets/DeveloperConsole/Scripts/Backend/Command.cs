namespace DeveloperConsole.Backend.Internal
{
    using System;
    ...
    internal class Command
    {
        ...
        internal virtual void Execute(string line)
        {
            if (m_command == null)
            {
                DeveloperConsole.Console.WriteLine("Missing target method for command: " + line);
            }
            else
            {
        ...
        protected object StringToObject(string value, Type type)
        {
            ...
            {
                DeveloperConsole.Console.WriteLine("command/variable | " + m_name + " : " + e.Message);
            }
